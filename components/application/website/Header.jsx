...
const toTitle = (s) => (s || "").trim().replace(/\s+/g, " ").replace(/\b\w/g, (m) => m.toUpperCase());
        ...
        <div className={`mx-auto ${containerMaxW} flex items-center justify-between lg:py-5 py-3 px-4 sm:px-6 lg:px-10 2xl:px-16`}>
          ...
          <div className="flex items-center gap-2">
            <Sheet>
              ...
              <SheetContent side="left" className="w-[80%] sm:w-[380px] p-0 flex flex-col [&>button.absolute.right-4.top-4]:hidden">
