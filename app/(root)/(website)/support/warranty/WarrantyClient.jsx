      ...
      <motion.div variants={stagger} className="grid gap-4 md:grid-cols-2">
        <motion.div variants={fadeUp}>
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>
                Standard warranty: <b>12 months</b> on manufacturing defects.
              </p>
              <p>Physical and liquid damage are not covered.</p>
        ...
        <motion.div variants={fadeUp}>
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>1) Submit a claim with issue details & images/video.</p>
