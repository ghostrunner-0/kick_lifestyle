...
export default function FAQSupport() {
  ...
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="mx-auto max-w-4xl py-4 space-y-6"
    >
      <motion.header variants={fadeUp} className="space-y-2">
        <h1 className="text-xl md:text-2xl font-semibold text-foreground">FAQ</h1>
      ...
      <motion.div variants={fadeUp}>
        <Card>
          <CardHeader className="font-medium text-foreground">Top questions</CardHeader>
          <CardContent>
