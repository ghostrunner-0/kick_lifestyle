...
const TEAM = [
  { name: "Sunit Begwani", role: "Chairman", photo: "", ig: "", li: "" },
  {
    ...
    role: "Founder & CEO",
    photo: "",
    ig: "https://www.instagram.com/itsmekumod/",
    li: "",
  },
  {
    name: "Priyanshu Jain",
    ...
    photo: "",
    ig: "https://www.instagram.com/jain.priyanshu.74/",
    li: "",
  },
...
export default function AboutClient() {
  ...
  return (
    <>
      <main className="mx-auto w-full max-w-[1400px] [padding-inline:clamp(1rem,5vw,5rem)] pb-20 pt-8 sm:pt-12 space-y-16">
        {/* ===== HERO / TITLE ===== */}
        <section
          id="hero"
        ...
        >
          <div className="relative overflow-hidden rounded-[28px] border bg-neutral-950 text-white px-6 py-12 sm:px-10 sm:py-16">
            ...
            <div className="relative z-30 flex flex-col items-center text-center">
              ...
              <h1 className="mt-4 font-semibold tracking-tight leading-[1.05] text-[clamp(28px,6.2vw,56px)]">
                Premium tech.{" "}
              ...
              <p className="mt-4 max-w-[62ch] text-white/85 text-sm sm:text-base">
        ...
        >
          ...
          <div className="mt-3 relative">
            <div
              className="
                flex w-max gap-8 sm:gap-10 whitespace-nowrap
              ...
              {PRESS_LOGOS.concat(PRESS_LOGOS).map((logo, i) => (
                <a
                  ...
                  className="
                    ...
                    shrink-0
                    min-w-[96px] sm:min-w-[112px] md:min-w-[128px]
                    px-2
                  "
                >
                  <SafeImg
        ...
        <section className="mx-auto w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-3 gap-4">
          <GlassCard
            ...
            title="Clear calls"
            desc="ENC + tuned mics for street-smart clarity."
          />
          <GlassCard
        ...
        <section className="mx-auto w-full max-w-[1200px] rounded-[22px] border overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 bg-neutral-100 min-h-64 grid place-items-center text-xs text-neutral-500">
        ...
        >
          <div className="flex items-end justify-between gap-3 flex-wrap">
            ...
            <p className="text-sm text-muted-foreground">
              People who obsess over the details — from sound to support.
            </p>
          </div>
            ...
            {TEAM.map((m) => (
              ...
              >
                ...
                <p className="mt-3 text-xs text-muted-foreground">
                  Building premium feel at honest prices — iterating fast with
                  community feedback.
                </p>
        ...
        <section className="mx-auto w-full max-w-[1200px] rounded-[22px] border p-6 sm:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            <div className="lg:col-span-4 rounded-xl bg-neutral-100 h-44 grid place-items-center text-xs text-neutral-500">
              Founder image / video
            </div>
            <div className="lg:col-span-8">
              <h3 className="text-xl font-semibold">
                Meet the Founder — Kumod Begwani
              </h3>
              <p className="mt-2 text-sm/6 text-muted-foreground">
                Kick Lifestyle started with a clear idea: build a Nepali brand
                that competes on innovation and price — then keep improving with
                community feedback.
              </p>
              <blockquote className="relative mt-4 rounded-xl border p-5">
                <Quote className="absolute -top-4 left-5 h-8 w-8 text-neutral-300" />
                <p className="mt-2 text-sm sm:text-base">
                  “We make premium feel accessible — honest pricing, real
                  quality, and support that cares.”
                </p>
        ...
        <section className="mx-auto w-full max-w-[1200px] rounded-[22px] border p-6 sm:p-8">
          ...
          <div
            ...
            style={{
              WebkitMaskImage:
                "linear-gradient(90deg, transparent 0, black 28px, black calc(100% - 28px), transparent 100%)",
              maskImage:
                "linear-gradient(90deg, transparent 0, black 28px, black calc(100% - 28px), transparent 100%)",
            }}
          >
        ...
        {/* ===== IMPACT ===== */}
        <section className="mx-auto w-full max-w-[1200px] rounded-[22px] border bg-neutral-50 p-6 sm:p-8">
        ...
        {/* ===== CTA ===== */}
        <section className="mx-auto w-full max-w-[1200px] rounded-[28px] border bg-neutral-950 text-white p-8 sm:p-12 text-center">
